...
CREATE TRIGGER insertar_5_Productos AFTER INSERT ON 5_productos
	FOR EACH ROW
	BEGIN
		INSERT INTO respaldo_5_productos VALUES (NULL, new.nombre,new.precio,null,new.stock,null, "INSERT", NOW() ,USER());
	END $$
DELIMITER ;
...
FOR EACH ROW
BEGIN
	  INSERT INTO respaldo_5_productos VALUES (NULL, new.nombre,new.precio,old.precio,new.stock,old.stock, "UPDATE", NOW() ,USER());
END $$
DELIMITER ;
...
FOR EACH ROW
BEGIN
	  INSERT INTO respaldo_5_productos VALUES (NULL, old.nombre,null,old.precio,null,old.stock, "DELETE", NOW() ,USER());
END $$
DELIMITER ;
